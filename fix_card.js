...
// Find and replace renderPlantCard function
const oldFunc = `function renderPlantCard(id, plant) {
...
const newFunc = `function renderPlantCard(id, plant) {
...
if (content.includes(oldFunc)) {
  ...
  console.log('SUCCESS: renderPlantCard updated');
} else {
  console.log('ERROR: old function not found');
  // Try to find what's actually there
  const idx = content.indexOf('function renderPlantCard');
  if (idx !== -1) {
    console.log('Found renderPlantCard at index:', idx);
