...
// ---- SAFE TRANSLATIONS (won't break JS identifiers) ----
const edits = [
...
// Fix nav link: on Chinese page, button says "EN" and links to index.html
html = html.replace(
...
// Verify all JS functions preserved
...
// Check key strings
const checks = ['園藝變得更簡單', '熱門植物', 'showAllPlantsView', 'renderPlants', 'showLoginToast', 'openLoginRequiredModal', 'closeLoginRequiredModal', 'EN</a>'];
for (const s of checks) {
  console.log(html.includes(s) ? 'OK: ' + s : 'MISSING: ' + s);
}

console.log('\nFile written. Size:', fs.statSync('plantglow/index-zh.html').size);