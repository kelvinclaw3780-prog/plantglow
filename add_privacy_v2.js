...
const testReplace = c.replace('</body>', 'TEST</body>');
console.log('Test replace worked:', testReplace.includes('TEST'));

// Now do the actual replace
c = c.replace('</body>', privacyPopup + '</body>');
console.log('Privacy popup added:', c.includes('id="privacy-popup"'));
...
console.log('Footer link updated:', c.includes('openPrivacyPopup()'));

fs.writeFileSync('C:/Users/kelvi/.openclaw/workspace-appcreator/plantglow/index.html', c, 'utf8');
console.log('File saved. Length:', c.length);