...
// Find the plantData section - using function handlePlantClick as the end marker
const startMarker = '// Plant data (free info for all, premium for subscribers)';
const endMarker = 'function handlePlantClick';
...
// Clean plantData - all ASCII, no special chars
const cleanPlantData = `// Plant data (free info for all, premium for subscribers)
    const plantData = {
      monstera: {
...
const result = content.substring(0, start) + cleanPlantData + '\n\n    ' + content.substring(end);
